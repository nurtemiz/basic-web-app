...
<head>
	...
	<title>Bütün Ürünler - AYAKKABIM</title>
		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					...
					<li class="active">Bütün Ürünler</li>
				</ul>
			</div>
		</div>
	</div>
            ...
            <div class="col-md-3 col-sm-6 hero-feature">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p>
                        	<a href="/myFinalProject/urunSil?urunid=${urun.urunid}" class="btn btn-primary" name="sil">Ürünü Sil</a>
                        	<a href="/myFinalProject/Guncelle?urunid=${urun.urunid}" class="btn btn-default">Güncelle</a>
                        </p>
                    </div>
                </div>
            </div>
