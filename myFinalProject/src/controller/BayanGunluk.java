...
@WebServlet("/bayangunluk")
public class BayanGunluk extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			preparedStatement = connection.prepareStatement("SELECT * FROM uruntablosu where kategorid=4");
		...
		response.sendRedirect("bayangunluk.jsp");
	}
