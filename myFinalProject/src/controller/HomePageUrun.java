...
@WebServlet("/homepage")
public class HomePageUrun extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			preparedStatement = connection.prepareStatement("SELECT *FROM uruntablosu ORDER BY urunadi DESC LIMIT 20;");
			// random ürün getirmek için --->>> 
			//preparedStatement = connection.prepareStatement("SELECT *FROM uruntablosu ORDER BY LIMIT 20;");
