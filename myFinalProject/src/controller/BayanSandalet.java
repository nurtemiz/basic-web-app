...
@WebServlet("/bayansandalet")
public class BayanSandalet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public BayanSandalet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			preparedStatement = connection.prepareStatement("SELECT * FROM uruntablosu where kategorid=5");
		...
		response.sendRedirect("bayansandalet.jsp");
	}
