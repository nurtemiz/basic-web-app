...
@WebServlet("/baygunluk")
public class BayGunluk extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			preparedStatement = connection.prepareStatement("SELECT * FROM uruntablosu where kategorid=6");
		...
		response.sendRedirect("baygunluk.jsp");
	}
