...
@WebServlet("/bayancuzdan")
public class BayanCuzdan extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			preparedStatement = connection.prepareStatement("SELECT * FROM uruntablosu where kategorid=12");
		...
		response.sendRedirect("bayancuzdan.jsp");
	}
