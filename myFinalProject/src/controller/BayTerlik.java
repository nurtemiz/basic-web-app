...
@WebServlet("/bayterlik")
public class BayTerlik extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			preparedStatement = connection.prepareStatement("SELECT * FROM uruntablosu where kategorid=9");
		...
		response.sendRedirect("bayterlik.jsp");
	}
