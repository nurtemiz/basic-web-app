    ...
    <!-- /.row -->
        ...
        <c:forEach items="${urunler}" var="urun">
            <div class="col-md-3 col-sm-6 hero-feature">
                <div class="thumbnail">
                <img src="images/${urun.urunResim}" class="img-rounded" alt="Cinque Terre" width="500" height="1000">
                <div class="caption">
                	<p>${urun.urunAdi}</p>
					<h3>${urun.urunFiyat} TL</h3>
                	<p><button href="/myFinalProject/SepetSil?urunid=${urun.urunid}" class="btn btn-default">Sil</button></p>
                	<div><a href="/myFinalProject/urunlistele">Alışverişe devam et</a></div>
            	</div>
				</div>           
            </div>
		</c:forEach>
...
<section id="inner-headline">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					<li><a href="/myFinalProject/Siparis"><i class="fa fa-home"></i>Alışverişi tamamla..</a><i class="icon-angle-right"></i></li>
				</ul>
			</div>
		</div>
	</div>
