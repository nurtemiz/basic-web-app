...
@WebServlet("/bayanbileklik")
public class BayanBileklik extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public BayanBileklik() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			preparedStatement = connection.prepareStatement("SELECT * FROM uruntablosu where kategorid=14");
		...
		response.sendRedirect("bayanbileklik.jsp");
	}
