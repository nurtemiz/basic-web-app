...
@WebServlet("/AdminListele")
public class AdminListele extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			while (resultSet.next()) {
				...
				String urunresmi = resultSet.getString("urunresmi");
				String urunfiyati = resultSet.getString("urunfiyati");
				int  kategorid = resultSet.getInt("kategorid");
				int  urunid = resultSet.getInt("urunid");
				urun urun = new urun(urunadi,urunresmi,urunfiyati,urunid,kategorid);
				urunler.add(urun);
			}
		...
		response.sendRedirect("butunurunler.jsp");
	}
