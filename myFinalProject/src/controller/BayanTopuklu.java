...
@WebServlet("/bayantopuklu")
public class BayanTopuklu extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			preparedStatement = connection.prepareStatement("SELECT * FROM uruntablosu where kategorid=2");
		...
		response.sendRedirect("bayantopuklu.jsp");
	}
