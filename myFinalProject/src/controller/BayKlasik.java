...
@WebServlet("/bayklasik")
public class BayKlasik extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			preparedStatement = connection.prepareStatement("SELECT * FROM uruntablosu where kategorid=8");
		...
		response.sendRedirect("bayklasik.jsp");
	}
