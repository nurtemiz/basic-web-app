	...
	<div class="container">
		<div class="row">
    		<div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
				<form class="register-form" role="form" method="POST"  action="j_security_check"  onsubmit="return kontrol()">
					<h2>Giriş Yap</h2>
					<hr class="colorgraph">
					<div class="form-group">
						<input type="text" name="j_username" id="username" class="form-control input-lg" placeholder="Username" tabindex="4">
					</div>
					<div class="form-group">
						<input type="password" class="form-control input-lg" name="j_password" id="password" placeholder="Parola">
					</div>
						<input type="checkbox" name="hatirla">Beni Hatırla</a>
						<c:if test="${param.err != null}">
							<span class="label label-danger"><c:out value="Invalid Username or Password"></c:out></span>
						</c:if>
					<hr class="colorgraph">
					<div class="row">
