...
@WebServlet("/bayspor")
public class BaySpor extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			preparedStatement = connection.prepareStatement("SELECT * FROM uruntablosu where kategorid=7");
		...
		response.sendRedirect("bayspor.jsp");
	}
